    ...
    return {
      ...
      games: [
        ...
        },
        {
          ...
          description: 'Witaj w fascynującym świecie gry "Okręty"! Ta emocjonująca gra strategiczna zapewni Ci godziny niesamowitej zabawy i wyzwań. Celem gry jest trafienie okrętu przeciwnika, który jest ukryty na planszy, na jednym z dostępnych pól. "Okręty" to gra, która wymaga zarówno spostrzegawczości, jak i umiejętności strategicznych. Musisz starannie rozważać swoje ruchy i dokładnie analizować planszę, aby odkryć ukryte okręty przeciwnika. Każde trafienie przynosi Ci ekscytację i satysfakcję. Przed Tobą nieskończone możliwości taktyczne. Możesz planować swoje ruchy, szukać wzorców i strategii, które pozwolą Ci odkryć okręty przeciwnika w jak najkrótszym czasie. Czy wybierzesz losowe pola, czy zastosujesz bardziej złożone metody analizy planszy? Decyzja należy do Ciebie! Niezależnie od tego, czy grasz z przyjaciółmi na tradycyjnej planszy, czy korzystasz z wirtualnej wersji gry, "Okręty" zawsze zapewni Ci wiele ekscytujących chwil. Możesz rywalizować z innymi graczami, podzielić się swoimi osiągnięciami i strategiami, a nawet uczestniczyć w turniejach online. Ta gra rozwija Twoje umiejętności logicznego myślenia, koncentracji i spostrzegawczości. Wymaga od Ciebie szybkiego podejmowania decyzji i adaptacji do zmieniającej się sytuacji na planszy. Bez względu na to, czy jesteś nowicjuszem, czy doświadczonym graczem, "Okręty" dostarczą Ci niezapomnianych chwil rozrywki. Czas zacząć przygodę i odkryć, jak wiele frajdy może dostarczyć Ci gra "Okręty"! Czekają na Ciebie emocje, strategie i zwycięstwa. Włącz wyobraźnię, zdobądź przewagę i pokaż swoje umiejętności taktyczne na morzu bitew!',
          rules: [
            'Podczas każdej gry dostępne są 2 plansze 10x10 pól.',
            'Na początku gry na lewej planszy gracz losuje okręty do momentu, kiedy rozmieszczenie okrętów mu odpoowiada.',
            'Rozmieszczane są w pionie lub w poziomie: 1 okręt po 4 pola, 2 okręty po 3 pola, 3 okręty po 2 pola, 4 okręty po 1 polu.',
            'Okręty nie można rozkładać na ukos.',
            'Okręty nie mogą się styktać bokami, nie mogą też się stykać w rogu.',
            ...
            'Po trafieniu okrętu przeciwnika pole zostaje oznaczone "trafiony", w przeciwnym wypadku pole zostaje oznaczone "pudło".',
            ...
            'Celem gry jest strącenie wszystkich okrętów przeciwnika.'
          ],
          active: true,
          link: { path: '/games/1'},
          isFavorite: false

      ...
      >
        ...
        <tbody>
          ...
          v-for="(room, index) in this.getGamesInProgress" :key="index">
            ...
            <td>
              {{
                room.players.filter((x) => x.playerId != this.getUserId)[0]
                  .userName
              }}
            </td>
            ...
            <td style="width: 50px">
              <span
                ...
                @click="this.$router.push({ path: `/play/${room.id}` })"
                >play_circle</span
              >
            </td>
          </tr>
      ...
      <div class="showHistoryTable">
        <div v-if="getHistory.length !== 0">
          ...
          <div v-if="getOwnId && getHistory.length !== 0" class="buttons">
            ...
            ></base-previous-button>
            <base-next-button
              :disabled="getHistPage === getCurrentPage"
              @click="nextPage"
            ></base-next-button>
